...
const TechGridCard: React.FC<TechGridCardProps> = React.memo(({ technology, status, progress, inQueue, onClick }) => {
                      ...
                      return (
                        <Box
                          ...
                          sx={{
                            ...
                            borderRadius: 0.5,
                            border: `1px solid ${
                              isCompleted ? alpha(theme.palette.success.main, 0.3) : alpha(theme.palette.grey[500], 0.3)
                            }`,
                            minWidth: 28,
                            position: 'relative',
                          }}
                      ...
                      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
                        ...
                        >
                          {researchTriggerInfo.item && (
                            <FactorioIcon itemId={researchTriggerInfo.item} size={16} showBorder={false} />
                          )}
                          <Typography
                            variant="caption"
                            sx={{
                  ...
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
                    ...
                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
                      {Object.entries(techRecipe?.in || {}).map(([packId, amount]) => (
                        ...
                        >
                          <FactorioIcon itemId={packId} size={28} showBorder={false} quantity={amount} />
                        </Box>
                      ))}
                    </Box>
