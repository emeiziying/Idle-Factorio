...
describe('FuelService', () => {
  ...
  describe('addFuel', () => {
    ...
    it('should reject incompatible fuel', () => {
      ...
      const result = fuelService.addFuel(facility.fuelBuffer!, 'uranium-fuel', 1, facility.facilityId);
    ...
    it('should reject non-fuel items', () => {
      const result = fuelService.addFuel(facility.fuelBuffer!, 'iron-plate', 1, facility.facilityId);
