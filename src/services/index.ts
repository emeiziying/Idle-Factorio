...
export { ServiceInitializer, ServiceLocator, GameConfig, SERVICE_NAMES } from './core';

// Data services - Game data loading and recipe management
export { DataService, RecipeService, DependencyService } from './data';
...
export { TechnologyService, UserProgressService } from './game-logic';

// System services - Fuel, power, and storage
export { FuelService, PowerService, StorageService, type GenericFuelBuffer } from './systems';

// Storage services - Game state persistence and configuration
export { GameStorageService } from './storage';
